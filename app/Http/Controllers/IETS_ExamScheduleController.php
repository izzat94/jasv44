...
dd( Input::all() );
   ...
   // return view('iets_examschedule', array('iets_examschedule' => $iets_examschedule, 'exam_date' => 'exam_time', 'exam_venue' => '', 'page' => 'home'));
    ...
    ['user_id', '=', Auth::id()]);
	 ...
	 $iets_examschedule = IetsSchedule::take(1)->get();
	 $ietsuserexam=new UserExamDetails;
$examuser1 = DB::table('ietsuserexam')->select(DB::raw('count(*) user_id'))->groupBy('schedule_id')->get();
...
$examuser=$examuser1->count();
		...
		$ietsuserexam=new UserExamDetails;
		$iets_examschedule = IetsSchedule::all();
