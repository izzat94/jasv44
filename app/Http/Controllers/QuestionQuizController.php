...
class QuestionQuizController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('questions_quiz.index', compact('questions'));
    }
    ...
    public function create()
    {
        ...
        return view('questions_quiz.create', compact('correct_options') + $relations);
    }
    ...
    {
        $question = QuestionQuiz::create($request->all());
    ...
    public function show($id)
    {
        ...
        return view('questions_quiz.show', compact('question') + $relations);
    }
    ...
    public function massDestroy(Request $request)
    {
        if ($request->input('ids')) {
            $entries = QuestionQuiz::whereIn('id', $request->input('ids'))->get();
