		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<ul class="breadcrumb">
				    ...
				    <ol><a href="compexam">Schedule</a></ol>
				    <ol class="active">Exam Attendant List</ol>        
				  </ul>
				</div>
    			...
    			<div class="dropdown1">
					  ...
					  <div class="dropdown-content1">
					   ...
					   1. In this form, the name of applicant that qualified to take comprehensive examination will be appear in this form.<br>
2. Secretariat IETS can select the applicant attendant to take the attendant of applicant which is attend or absent.<br> 
3. Secretariat IETS can select the Status to give the marks status of applicant which is pass,fail or acknowledge if the applicant is absent the examination.<br>
4. Secretariat IETS can click button "Save" to save the applicant exam information that has been changes.<br>
					  </div>
