	...
	<script>   
				    ...
				    function addRow1() {
						...
						for(var i=0;i<cols;i++){
							...
							cell1.innerHTML = '<td><form onclick="deleteRow(this)" align="center"><input type="image" src="images/delete.ico" alt="Delete" width="15" height="15"></form><center><br><img src="images/edit.png" height=15px width=15px></center></td>';
						}
						for(var i=0;i<cols;i++){
							cell1 = row.insertCell(i);
		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<ul class="breadcrumb">
				    ...
				    <ol class="active">Panel Assignment</ol>        
				  </ul>
				</div>
