		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<ul class="breadcrumb">
    			...
    			<h2>Exam Schedule for IETS Competent Person<br></h2>

    			<div class="dropdown1">
				 	
					  <button class="dropbtn1">Instruction : </button>
					  <div class="dropdown-content1">
					   1. Secretariat IETS can enter the title of exam at the text field provide.<br>
					   2. Secretariat IETS can choose the date, time and enter venue of exam at the text field provided.<br>
						3. Secretariat IETS can click "Confirm" button to confirm the date,time and venue that has been filled.<br>
						4. Secretariat IETS can view the date, time and date at the table below the "Confirm" button.
					  </div>
