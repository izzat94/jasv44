		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<ul class="breadcrumb">
				    ...
				    <ol class="active">Certificate Approval</ol>        
				  </ul>
				</div>
    			...
    			<div class="dropdown1">
					  ...
					  <div class="dropdown-content1">
					   1. The purpose of this page is to approve the certificate according to the applicant status and marks.<br>  
						2. Secretariat IETS can view the marks and status of applicant procedure with clicking the button "View".<br>
						3. Secretariat IETS can fill the specialized area of the assignment at the text field of Specialized Area.<br>
						4. Secretariat IETS can endorse the certificate with select approve or reject at the field of Endorsement.<br>
						6. Secretariat IETS can give remarks or commend about the status and marks of the applicant procedure at the text area of Remarks(Comment)<br>
						7. Secretariat IETS can certified or not certified the certification at the field of Status<br>
						8. Secretariat IETS can click the button "Save" to save the progress that have been made.
					  </div>
				...
				<thead>
				    ...
				    <tbody>
				      <tr>
				        ...
				        <td>Muhd Izzat</td>
				        <td>941203069897</td>
				        <td><center>Consultant IETS</center></td>
				        <td><center>Water pollution Control</center></td>
				        <td><form action="endorse" method="get">
				...
				<thead>
				    ...
				    <tbody>
				      <tr>
				        ...
				        <td>Muhd Izzat</td>
				        <td>941203069897</td>
				        <td><center>Consultant EITS</center></td>
				        <td><center>Water pollution Control</center></td>
