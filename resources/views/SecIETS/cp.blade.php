		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<ul class="breadcrumb">
				    ...
				    <ol class="active">Competent Person (CP) Profile</ol>        
				  </ul>
				</div>
    			...
    			<div class="dropdown1">
					  ...
					  <div class="dropdown-content1">
					    1. In this Form, Secretariat IETS can view the CP profile of the applicant.<br>
2. Secretariat can select the CP status and Renewal Certificate Status according to the status of applicant.<br>
3. Secretariat IETS can click the "Email".button to send email to the applicant of notification to renew the certificate.<br>
4. The applicant Renewal Certificate is auto-generate after the applicant requesting to renew his/her certificate.<br>
5. Secretariat IETS can click "Save" button to save the changes that has been made.<br>
					  </div>
