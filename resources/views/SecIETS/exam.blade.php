	      	...
	      	<ul class="breadcrumb">
    			...
    			<div class="dropdown1">
					  ...
					  <div class="dropdown-content1">
					   1. Secretariat IETS can enter question,Answer (A,B,C,D) and correct answer at the text field provided.<br>
2. Secretariat IETS can select Type of Question and Level of Question at the radio button provided.<br>
3. Secretariat IETS can click button "Save" to save the question of comprehensive examination.<br>
4. Secretariat IETS can view the previous filled question in the table below.<br>
5. Secretariat IETS can click "Edit" button to edit the question.<br>
6. Secretariat IETS can click "X" button to delete the question.<br>
7. Secretariat IETS can click button "Save" to save the question of Comprehensive Exam.
					  </div>
