	      	...
	      	<ul class="breadcrumb">
    			...
    			<div class="dropdown1">
					  ...
					  <div class="dropdown-content1">
					    1. Secretariat IETS can choose the date, time and enter venue of interview session at the text field provided.<br>
2. Secretariat IETS can click "Confirm" button to confirm the date,time and venue that has been filled.<br>
3. Secretariat IETS can view the date, time and date at the table below the "Confirm" button.<br>
4. Secretariat IETS can click the "Email Applicant" to send the information of interview session to the applicant email.<br>
					  </div>
