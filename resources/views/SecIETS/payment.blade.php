    			...
    			<h1>Pre-Qualification Payment of Applicant <br></h1>         
				 ...
				 <div class="dropdown1">
					  ...
					  <div class="dropdown-content1">
					    1. In this form, Secretariat IETS can view the list of applicant payment with proof.<br>
2. Secretariat IETS can click the payment proof link to view applicant payment proof.<br>
3. Secretariat IETS can click success if the payment is successful and the pending if the payment amount is not enough.<br>
4. Secretariat IETS can click button "Save" to save the list of applicant payment after make changes.<br>
					  </div>
