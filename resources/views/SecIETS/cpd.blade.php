		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<ul class="breadcrumb">
				    ...
				    <ol class="active">Continuous Professional Development (CPD)</ol>        
				  </ul>
				</div>
    			...
    			<div class="dropdown1">
					  ...
					  <div class="dropdown-content1">
					   1. In this Form, Secretariat IETS can view the CPD points of the applicant.<br>
2. Secretariat can click the name of applicant to view the QP profile of the applicant.<br>
4. Secretariat IETS can click "Save" button to save the changes that has been made.
					  </div>
				...
				<table class="order-table table" id="list">
				  ...
				  <button href="" class="btn btn-success">Save</button><br><br>          
