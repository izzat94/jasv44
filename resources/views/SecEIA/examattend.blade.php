...
2. Secretariat EIA can select the applicant attendant to take the attendant of applicant which is attend or absent.<br> 
3. Secretariat EIA can select the Status to give the marks status of applicant which is pass,fail or acknowledge if the applicant is absent the examination.<br>
4. Secretariat EIA can click button "Save" to save the applicant exam information that has been changes.<br>
					  </div>
