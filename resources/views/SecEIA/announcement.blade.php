				...
				<div class="col-md-12 col-md-offset-0">
				 ...
				 <div class="dropdown1">
					  ...
					  <div class="dropdown-content1">
					    1. Secretariat EIA can enter announcement by clicking the "Add Announcement" button.<br>
					    2. The announcement can be view, edit or delete in the table below.<br>
						3. The announcement entered by Secretariat EIA will be shown in the announcement box at the Home Page.
					  </div>
				...
				<table class="order-table table" id="myTable">
				    ...
				    <tbody>
				      <tr>
				        ...
				        <td><a>Consultant_needed.pdf<a></td>
