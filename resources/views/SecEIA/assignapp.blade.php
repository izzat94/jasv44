	      	...
	      	<ul class="breadcrumb">
    			...
    			<div class="dropdown1">
					  ...
					  <div class="dropdown-content1">
					   1. Secretariat EIA can assign assignment to applicant with assignning the assign code that have been generate at the master file<br>  
						...
						4. Secretariat EIA can set the status pass or fail to the assignmet of the applicant<br>
						5. Secretariat EIA can click the button "Save" to save the progress that have been made.<br>
					  </div>
