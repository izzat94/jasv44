	      	...
	      	<ul class="breadcrumb">
    			...
    			<div class="dropdown1">
					  ...
					  <div class="dropdown-content1">
					    1. In this Form, Secretariat EIA can set the interview session for applicant and can set the attendance of the applicant.<br>
2. Secretariat can click "Assign" button to set the date, time and venue of interview session.<br>
3. Secretariat EIA can select the attendance of the applicant.
					  </div>
