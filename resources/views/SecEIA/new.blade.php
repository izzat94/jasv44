			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<ul class="breadcrumb">
    			...
    			<div class="dropdown1">
					  ...
					  1. Secretariat EIA can enter announcement in the text area and click button "Submit".<br>
2. The announcement entered by Secretariat EIA will be shown in the announcement box at the Home Page.
					  </div>
