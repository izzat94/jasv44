		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<ul class="breadcrumb">
				    ...
				    <ol class="active">Applicant Payment</ol>        
				  </ul>
				</div>
    			...
    			<h1>Pre-Qualification Payment of Applicant <br></h1>         
				 ...
				 <div class="dropdown1">
					  ...
					  <div class="dropdown-content1">
					    1. In this form, Secretariat EIA can view the list of applicant payment with proof.<br>
2. Secretariat EIA can click the payment proof link to view applicant payment proof.<br>
3. Secretariat EIA can click success if the payment is successful and the pending if the payment amount is not enough.<br>
4. Secretariat EIA can click button "Save" to save the list of applicant payment after make changes.<br>
					  </div>
				...
				<table class="order-table table" id="myTable">
				    ...
				    <tbody>
				      <tr>
				        <td></td>
				        <td><a href="payinfo">Muhd Izzat</a></td>
				        <td>941203069897</td>
				        <td><center>Applicant Registration</center></td>
				      ...
				      <tr>
				        <td></td>
				        <td><a href="payinfo">Nasih Ulwan</a></td>
				        <td>931203069897</td>
				        <td><center>Resit Examination</center></td>
