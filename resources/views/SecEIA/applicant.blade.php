		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<ul class="breadcrumb">
				    ...
				    <ol class="active">Applicant Registration</ol>        
				  </ul>
				</div>
    			...
    			<div class="dropdown1">
					  ...
					  <div class="dropdown-content1">
					   1. Secretariat EIA can click the applicant name to view the applicant registeration form from section A to Section F.<br>  
						2. Secretariat can approve or reject the applicant registeration if the the applicant not fill the form following the criteria.<br>
						3. Secretariat EIA can view the comment that have been given at the applicant registeration form.<br>
					  </div>
				...
				<table class="order-table table" id="myTable">
				    ...
				    <tbody>
				      <tr>
				        <td>1.</td>
				        <td><a href="appinfo">Muhd Izzat</a></td>
				        <td>941203069897</td>
				        <td></td>
				        <td>New</td>
				      </tr>
				      ...
				      <tr>
				        <td>2.</td>
				        <td><a href="appinfo">Nasih Ulwan</a></td>
				        <td>931203069897</td>
				        <td></td>
				        <td>New</td>
				      </tr>
