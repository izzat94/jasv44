	      	...
	      	<div class="breadcrumb flat">
    			...
    			{!! Form::open(array('url'=>'eiaquestion/uploadFiles', 'data-parsley-validate' => '', 'method'=>'POST', 'enctype' => 'multipart/form-data', 'files'=>true)) !!}
					  ...
					  <form action="{{ url('eiabank/create') }}" method="get">
					    <input type="submit" class="btn btn-success" value="Question Bank"/></form><br><br> </div>   
				...
				<table class="order-table table" id="list" style="width:90%;" align="center">
				      ...
				      <tr>
				       ...
				       @endif
				        ...
				        <br><br><button type="button" style="width:200%;" title="Question Preview" data-toggle="modal" data-target="#yourModal{{$eiaquestions->id}}">Preview</button>
				        </td>
				      ...
				      <div class="modal-dialog" role="document">
				        <div class="modal-content">
						  ...
						  @endif
						    ...
						    <br><br><input type="radio" name="level" required="" value="a"> {{$eiaquestions->a}}
							<br><input type="radio" name="level" required="" value="b"> {{$eiaquestions->b}}
							<br><input type="radio" name="level" required="" value="c"> {{$eiaquestions->c}}
							<br><input type="radio" name="level" required="" value="d"> {{$eiaquestions->d}}
