		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<div class="breadcrumb flat">
    			...
    			{!! Form::model($eiaquestion, ['route' =>['eiaquestion.update', $eiaquestion->id], 'method' => 'PUT', 'files' => true]) !!}
					    ...
					    <center>
					     ...
					     <th>
					      <center>{!! Html::linkRoute('eiaquestion.show', 'Cancel', array($eiaquestion->id), array('class' => 'btn btn-danger btn-block', 'style' => 'width:150px')) !!}</center>
					      </th>
					      </tr>
					      </table></center><br>
