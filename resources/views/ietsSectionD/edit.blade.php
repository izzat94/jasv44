    ...
    <div class="panel panel-primary">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" href="#collapse1">IETS Section D Instruction :</a>
        </h4>
      </div>
...
<div class="table-responsive">
  ...
  <table class="table">
    <tbody>
    {!! Form::model($ietsSectionD, ['route' =>['ietsSectionD.update', $ietsSectionD->id], 'method' => 'PUT', 'files' => true]) !!}
      <tr>
        <td>
          <label>Date</label>
        ...
        <td>
            ...
            <div class="input-group">
              ...
              {!! Form::date('starttrainning', null, array('id' => 'datepicker', 'class' => 'form-control', 'style' => 'width: 60%', 'title' => 'mm/dd/yyyy','required' => '' )) !!}
            </div>
          </div>
          </br></br>
          <div class="col-lg-10">
            <div class="input-group">
              ...
              {!! Form::date('endtraining', null, array('id' => 'datepicker2', 'class' => 'form-control', 'style' => 'width: 60%', 'title' => 'mm/dd/yyyy','required' => '' )) !!}
            </div>
          </div>
        </td>
      </tr>
      <tr>
        <td style="width: 25%">
          <label>Name of Course / Seminar / Conference </label>
          <label style="color: red">*</label>
        </td>
        <td>
          <label>:</label>
