  ...
  <table class="table table-hover">
    ...
    <tbody>
      ...
      <tr style="background-color: #f2f2f2">
        <td style="text-align: center;">{{ date('d/m/Y', strtotime($ietsSectionDs->starttrainning)) }}</td>
        <td style="text-align: center;">{{ date('d/m/Y', strtotime($ietsSectionDs->endtraining)) }}</td>
      ...
      @endforeach
            ...
            <button style="margin-right: 5%" type="button" class="button next" onclick="window.location.href='/ietsSectionE/create'">Next</button>


            <button type="button" class="button add" data-toggle="modal" data-target="#ietsSecD">Add New</button>
...
<div class="table-responsive">
  ...
  <table class="table">
    <tbody>
    {!! Form::open(['route' => 'ietsSectionD.store', 'data-parsley-validate'=> '']) !!}
      <tr>
        <td>
          <label>Date</label>
        ...
        <td>
            ...
            <div class="input-group">
              ...
              {!! Form::date('starttrainning', '', array('id' => 'datepicker', 'class' => 'form-control', 'style' => 'width: 65%', 'required' => '' )) !!}
            </div>
          </div>
          </br></br>
          <div class="col-lg-10">
            <div class="input-group">
              ...
              {!! Form::date('endtraining', '', array('id' => 'datepicker2', 'class' => 'form-control', 'style' => 'width: 65%', 'required' => '' )) !!}
            </div>
          </div>
        </td>
      </tr>
