				    ...
				    $('[data-toggle="popover"]').popover();   
                  		...
                  		<div class="col-md-2 col-sm-2 col-md-offset-0 box0">
                  			<div class="box1">
					  			...
					  			<a style="color:orange;" href="{{ url('assignapp/create') }}"><h3>Assignment<br><br>{{ $assignapp }}</h3></a>
                  			</div>
                  		...
                  		<div class="col-md-2 col-sm-2 col-md-offset-0 box0">
                  			<div class="box1">
					  			...
					  			<a style="color:green;" href="{{ url('proiv/create') }}"><h3>Interview<br><br>{{ $proiv }}</h3></a>
                  			</div>
                  		...
                  		<div class="col-md-2 col-sm-2 col-md-offset-0 box0">
                  			<div class="box1">
					  			...
					  			<a style="color:blue;" href="{{ url('cert/create') }}"><h3>Certificate<br><br>{{ $cert }}</h3></a>
                  			</div>
                      ...
                      <!-- SERVER STATUS PANELS -->
                      		...
                      		<div id="myDIV" style="color:maroon; visibility: hidden; display: none;" class="white-panel pn donut-chart">
								...
								<div id="myDIV" class="row">
									<div class="col-sm-6 col-xs-6 goleft">
										<p><i class="fa fa-database"></i>{{ $applicant }}%</p>
									</div>
	                      		</div>
                      	...
                      	<div class="col-md-3 col-sm-4 mb">
                      		<div id="myDIV1" style="color:brown; visibility: hidden; display: none;" class="white-panel pn donut-chart">
                      			<div class="white-header">
						  			<a style="color:brown;" href="{{ url('payment/create') }}"><h5>Payment : Paid vs Applicant</h5></a>
                      			</div>
								<div class="row">
									<div class="col-sm-6 col-xs-6 goleft">
										<p><i class="fa fa-database"></i>{{ $payment }}%</p>
									</div>
	                      		</div>
