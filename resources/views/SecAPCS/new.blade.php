			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<ul class="breadcrumb">
    			...
    			<div class="dropdown1">
					  ...
					  <div class="dropdown-content">
					  1. Secretariat APCS can enter announcement in the text area and click button "Submit".<br>
2. The announcement entered by Secretariat APCS will be shown in the announcement box at the Home Page.
					  </div>
					
				</div><br><br> 

					{!! Form::open(array('route' => 'announce.store', 'data-parsley-validate' => '')) !!}

    				<div class="form-group">

							<label id="subject">Subject &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp : </label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
					      	<input type="text" name="subject" id="subject" required="" maxlength="255" style="width: 700px;"><br>
					      	<br><label id="announcement">Announcement &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp : </label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
					      	<textarea name="announcement" id="announcement" required="" rows="4" cols="50"></textarea>
