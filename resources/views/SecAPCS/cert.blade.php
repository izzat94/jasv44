    			...
    			<div class="dropdown1">
					  ...
					  <div class="dropdown-content1">
					   1. The purpose of this page is to approve the certificate according to the applicant status and marks.<br>  
						2. Secretariat APCS can view the marks and status of applicant procedure with clicking the button "View".<br>
						3. Secretariat APCS can fill the specialized area of the assignment at the text field of Specialized Area.<br>
						4. Secretariat APCS can endorse the certificate with select approve or reject at the field of Endorsement.<br>
						6. Secretariat APCS can give remarks or commend about the status and marks of the applicant procedure at the text area of Remarks(Comment)<br>
						7. Secretariat APCS can certified or not certified the certification at the field of Status<br>
						8. Secretariat APCS can click the button "Save" to save the progress that have been made.
					  </div>
