	      	...
	      	<ul class="breadcrumb">
    			...
    			<div class="dropdown1">
					  ...
					  <div class="dropdown-content1">
					    1. In this form, Secretariat APCS can upload .pdf file of Refference.<br>
				...
				<table class="order-table table" id="list">
				    ...
				    <tbody>
				      <tr>
				        ...
				        <td>28/02/2017</td>
				        <td id="but"><center><button>Pulish</button></center><br><form onclick="deleteRow(this)" align="center">
