	      	...
	      	<ul class="breadcrumb">
    			...
    			<div class="dropdown1">
					  ...
					  <div class="dropdown-content1">
					    1. In this form, Secretariat APCS can upload .pdf file of Syllibus.<br>
2. Secretariat APCS can click the button "Upload" to upload the file into the applicant login application to download by applicant.<br>
3. The upload file must below than 10MB and format of .pdf file.
					  </div>
    			...
    			<form>
					    ...
					    <label for="usr"><br>Syllabus Upload (.pdf) : </label>
					      <br><center><input type="file"  name="fileToUpload" id="fileToUpload" accept=".pdf , .doc , .docx , .txt" onchange="myFunction()" required="" multiple></center>
					      <br><p id="demo"></p>
					      <script>
					      ...
					      <label><br><b>File Type: .pdf, .doc, .docx, .txt	|	Max File Upload: 10	|	Max Size Upload: 10MB</b><br>
					      	 ...
					      	 <div style="clear:both">
						        ...
						        <br>
					      <input class="btn btn-success" type="button" value="Save" name="save" onclick="AddData() "><hr><br>
					    </div>
					  </form>
