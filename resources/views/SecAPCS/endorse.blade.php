		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<ul class="breadcrumb">
				    ...
				    <ol><a href="cert">Certificate Approval</a></ol>
				    <ol class="active">Certificate Information</ol>        
				  </ul>
				</div>
    			...
    			<div class="dropdown1">
					  ...
					  <div class="dropdown-content1">
					   1. In this Form, Secretariat APCS can view the status and marks of the applicant.<br>
2. Secretariat APCS can click "Save" button to save the changes that has been made.
					  </div>
