    			...
    			<div class="dropdown1">
					  ...
					  <div class="dropdown-content1">
					   1. The purpose of this page is to generate the assignment and assign code to be use in the page of applicant assignment and panel assignment.<br>  
						2. Secretariat APCS can fill the title of the assignment at the text field of Topic.<br>
						3. Secretariat APCS can fill the specialized area of the assignment at the text field of Specialized Area.<br>
						4. Secretariat APCS can upload the assignment with clicking the button "Choose File" at the text field of Upload PCER<br>
						5. The Assign Date and Dateline can be set by date.<br>
						6. Secretariat APCS can fill the code of assign for example "APCS01" at the text field of Assign Code to be assign to applicant and panel.<br>
						7. Secretariat APCS can click the button "Save" to save the progress that have been made.<br>
						8. Secretariat APCS can view the uploaded assignment at the table below.
					  </div>
