		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<ul class="breadcrumb">
				    ...
				    <ol class="active">Applicant Assignment</ol>        
				  </ul>
				</div>
    			...
    			<div class="dropdown1">
					  ...
					  <div class="dropdown-content1">
					   1. Secretariat APCS can assign assignment to applicant with assignning the assign code that have been generate at the master file<br>  
						2. Secretariat can set the date hardcopy received field after the applicant have submit the assignment hardcopy.<br>
						3. The date softcopy received field will automatically generated after the applicant have submit the assignment softcopy.<br>
						4. Secretariat APCS can set the status pass or fail to the assignmet of the applicant<br>
						5. Secretariat APCS can click the button "Save" to save the progress that have been made.<br>
					  </div>
				...
				<table class="order-table table" id="list">
				    <thead>
				      <tr>
				        ...
				        <th onclick="sortTable(4)">Assign Code</th>
				        <th onclick="sortTable(5)">Date Hardcopy Received</th>
				        <th onclick="sortTable(6)">Date Softcopy Received</th>
				        <th onclick="sortTable(7)">Marks</th>
