			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<div class="breadcrumb flat">
				...
				<table class="table">
				    ...
				    @foreach($eiapayinfo as $eiapayinfos)
				      <tr>
				      <td></td>
				        <td>{{$users->name}}</td>
				        <td>{{$users->nric}}</td>
				        <td><center>{{$eiapayinfos->amount}}</center></td>
				        <td><center>{{$eiapayinfos->date}}</center></td>
				        <td><center>{{$eiapayinfos->referenceNo}}</center></td>
				        <td><center><a style="color: blue;" href="/backend/uploads/{{$eiapayinfos->slip}}">{{$eiapayinfos->slip}}</a></center></td>
				        <td><center><form action="{{ url('eiapayment/show') }}" method="get">
				        <button type="submit" style="width:80px;" name="pay1" value="Approved"/>Approve</button><br><br>
					    <button type="submit" style="width:80px;" name="pay1" value="Declined"/>Decline</button>
					</form></td>
				      </tr>
				      @endforeach
				    @endforeach
