            ...
            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
              <div class="cols-sm-10">
                <div class="input-group">
                  ...
                  <input  type="text" class="form-control" name="name" id="name"  placeholder="Enter your Name" value="{{ old('name') }}" required autofocus oninput="this.value=this.value.replace(/[^A-Za-z ]/g,'');"/>
                  @if ($errors->has('name'))
            ...
            <div class="form-group{{ $errors->has('nric') ? ' has-error' : '' }}">
              <div class="cols-sm-10">
                <div class="input-group">
                  ...
                  <input  type="text" class="form-control" name="nric" id="nric"  placeholder="Enter your I/C" style="width: 50%" value="{{ old('nric') }}" required autofocus oninput="this.value=this.value.replace(/[^0-9]/g,'');"/>
                  @if ($errors->has('nric'))
                      <span class="help-block">
