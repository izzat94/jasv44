...
<div class="row content">
  ...
  <center>
   ...
   download="Appendix III for LDP2M2 Guidance Document - BMPs Description NRH_edit.pdf">- Appendix III</a><br>
      <hr>
      <h3>Quiz</h3>
      <p>1. Environmental Impact Assessment Guideline (to be referred to as the EIA Guideline) in Malaysia is prepared in accordance with the requirements of _______ of the Environmental Quality Act (EQA), 1974 (Act 127).</p>
       <div class="radio">
...
<div class="col-md-4 col-md-offset-4">
  <a href="/modul5quiz2" class="btn btn-lg btn-primary btn-block" role="button">Next</a>
