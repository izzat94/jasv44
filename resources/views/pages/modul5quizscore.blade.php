...
<div class="row content">
  ...
  <center>
   ...
   download="Appendix III for LDP2M2 Guidance Document - BMPs Description NRH_edit.pdf">- Appendix III</a><br>
      <hr>
      <h3>Congratulations! You already finish quiz for Module 5</h3>
      <h2>SCORE: 3/5</h2>
      <h3>You may proceed to summary of modules' quizes</h3><br/>
       
         <div class="text">

        <p class="text-danger"><strong>* Please click next button to proceed to summary of modules' quizes</strong></p>
    
      </div>

<div class="col-md-4 col-md-offset-4">
  <a href="/modulsummary" class="btn btn-lg btn-primary btn-block" role="button">Next</a>
