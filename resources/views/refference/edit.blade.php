    			...
    			{!! Form::model($refference, ['route' =>['refference.update', $refference->id], 'method' => 'PUT', 'files' => true]) !!}
					      ...
					      <div class="input-group" style="width: 100%;">
						    ...
						    <div class="input-group" style="width: 100%;">
						      ...
						      <center><input id="original_filename" type="file" class="form-control" name="original_filename" accept=".pdf , .doc , .docx , .txt" onchange="myFunction()" multiple="multiple" style="width: 100%;"></center>
						    </div>
					      ...
					      <label><center><b>File Type: .pdf, .doc, .docx, .txt	|	Max File Upload: 10	|	Max Size Upload: 10MB</b></center></label><br><br>
