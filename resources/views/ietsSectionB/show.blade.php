  ...
  <table class="table table-hover">
    ...
    @foreach($ietsSectionB as $ietsSectionBs)
      <tr style="background-color: #f2f2f2">
        ...
        <td style="text-align: center;">{{ date('d/m/Y', strtotime($ietsSectionBs->from)) }}</td>
        <td style="text-align: center;">{{ date('d/m/Y', strtotime($ietsSectionBs->to)) }}</td>
        <td>
        <a class="file" href="/image/{{$ietsSectionBs->cert}}">{{$ietsSectionBs->cert}}</a>
        </td>
        <td><center>
      ...
      @endforeach
            ...
            <button style="margin-right: 10%" type="button" class="button next" onclick="window.location.href='/ietsSectionC/create'">Next</button>
...
<tr>
 ...
 -->              <input type="file" name="featured_image" accept=".pdf" required="">
        </td>
      </tr>
    </tbody>
  </table>
