    			...
    			{!! Form::model($question, ['route' =>['apcsquestion.update', $question->id], 'method' => 'PUT', 'files' => true]) !!}
					    ...
					    <div class="form-group">
					      ...
					      <div class="input-group" style="width: 100%;">
						    ...
						    {{ Form::select('specialized_id', $specializes, null, ['class' => 'form-control' ,'style' => 'width:97.7%;']) }}
					     ...
					     <th>
					      <center>{!! Html::linkRoute('apcsquestion.show', 'Cancel', array($question->id), array('class' => 'btn btn-danger btn-block', 'style' => 'width:150px')) !!}</center>
					      </th>
					      </tr>
					      </table></center><br>
