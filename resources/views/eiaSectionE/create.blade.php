...
<div class="table-responsive">
   ...
   <label style="color: blue">Please select TWO specialized area</label>
...
], '', array('class' => 'form-control', 'style' => 'width: 90%', 'required' => ''))}}
        </br></br>
        </center></td>
        <td><center>
        </br>
...
<button style="margin-right: 10%" type="submit" class="button next">Next</button>
  {!! Form::close() !!}
