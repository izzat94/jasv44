				    ...
				    $('[data-toggle="popover"]').popover();   
                  		...
                  		<div class="col-md-2 col-sm-2 col-md-offset-0 box0">
                  			<div class="box1">
					  			...
					  			<a style="color:orange;" href="{{ url('ietsassignapp/create') }}"><h3>Assignment<br><br>{{ $ietsassignapp }}</h3></a>
                  			</div>
                  		...
                  		<div class="col-md-2 col-sm-2 col-md-offset-0 box0">
                  			<div class="box1">
					  			...
					  			<a style="color:green;" href="{{ url('ietsproiv/create') }}"><h3>Interview<br><br>{{ $ietsproiv }}</h3></a>
                  			</div>
                  		...
                  		<div class="col-md-2 col-sm-2 col-md-offset-0 box0">
                  			<div class="box1">
					  			...
					  			<a style="color:blue;" href="{{ url('ietscert/create') }}"><h3>Certificate<br><br>{{ $ietscert }}</h3></a>
                  			</div>
