...
<div class="container">
	...
	<h5 style="margin-left:15%;">Below are the details of the Comprehensive Examination:</h5>
					 ...
					 <table>
					<tr></tr>
					<table class="table" style="margin-left:15%;width:70%" method="POST">
					<?php
						foreach ($iets_examschedule as $exam_schedule) {
					?>
					<tr>
					<th style="width:0.2%">Type of Exam:</th>
					<td style="width:1%">{{ $exam_schedule->typeofexam }}</td>
					</tr>
					<tr>
					<th style="width:0.2%">Date:</th>
					<td style="width:1%">{{ date('d/m/Y', strtotime($exam_schedule->date))}}</td>
					</tr>
					<tr>
					...
					<td id="seat2"style="width:1%"><input hidden>{{ $exam_schedule->seat}}</td>
					</tr>
	...
	<center> 
 <a id="show-button" href="" class="btn btn-primary">Confirm</a> <br>
