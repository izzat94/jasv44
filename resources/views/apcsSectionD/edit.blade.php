...
<div class="table-responsive">
  ...
  <table class="table">
    <tbody>
    {!! Form::model($apcsSectionD, ['route' =>['apcsSectionD.update', $apcsSectionD->id], 'method' => 'PUT', 'files' => true]) !!}
    <tr>
        <td style="width: 20%">
        ...
        <div class="col-lg-11">
          ...
          <br>
          <div id="numdays" class="left"><label class="form">Number of days:</label><!-- <input type="textbox" class="form-control" id="numdays2" name="numdays" readonly="readonly" style="width: 20%" /> -->
