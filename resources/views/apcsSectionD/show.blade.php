  ...
  <table class="table table-hover">
    <thead>
      <tr style="background-color: #d9d9d9">
        <th style="text-align: center;">Date of Project Start</th>
        <th style="text-align: center;">Date of Project Completion</th>
        <th style="text-align: center;">Number of Days</th>
        <th style="text-align: center;">Number of Months</th>
        <th style="text-align: center;">Title of Proposal</th>
        <th style="text-align: center;">Name of Client</th>
        <th style="text-align: center;">Address of Client</th>
    ...
    <tbody>
      ...
      <tr style="background-color: #f2f2f2">
        ...
        <td style="text-align: center;">{{ $apcsSectionDs->numdays }}</td>
        <td style="text-align: center;">{{ $apcsSectionDs->numMonths }}</td>
      ...
      @endforeach
            ...
            <button style="margin-right: 5%" type="button" class="button next" onclick="window.location.href='/apcsSectionE/create'">Next</button>


            <button type="button" class="button add" data-toggle="modal" data-target="#apcsSecD">Add New</button>
...
<div class="table-responsive">
  ...
  <table class="table">
    <tbody>
    {!! Form::open(['route' => 'apcsSectionD.store', 'data-parsley-validate'=> '']) !!}
      <tr>
        <td style="width: 20%">
          <label>Date</label>
