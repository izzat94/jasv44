...
<!--           {{ Form::radio('bumiputerastatus', 'Bumiputera' , true) }}
      ...
      <tr>
        <td colspan="3">
                <div class="col-xs-12" style="height:50px;"></div>
           &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp<em><input id="txt" class="field" name="agree" type="checkbox" value="1">Check this box if you are an existing consultant</em>
      </div></div>
      ...
      <tr>
        <td>
        <div class="container" id="txtC" style="display:none; background-color: transparent; width: 80%">
          &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp<label for="example-text-input" class="col-2 col-form-label">Registered Number</label>
          <!-- <label for="example-text-input" style="color: red" class="col-2 col-form-label">*</label> --></div>
        </td>
        <td>
        <div class="container" id="txtD" style="display:none; background-color: transparent; width: 80%">
          <label for="example-text-input" class="col-2 col-form-label">:</label></div>
        </td>
        <td>
        <div class="container" id="txtE" style="display:none; background-color: transparent; width: 80%">
          <!-- {{ Form::text('regNo', null, array('class' => 'form-control', 'style' => 'width: 30%', 'placeholder'=>'Eg: AB123'))}} -->
          <input type="text" pattern="\d+" name="regNo" class="form-control" style="width: 30%" placeholder="Eg: Eg: AB123" minlength="5" maxlength="11" title="Enter digit only. Min : 10, Max : 11"/>
          </div>
        </td>
      </tr>
      </tbody>
    ...
    <!-- <label for="example-text-input" style="color: red" class="col-2 col-form-label">*</label> -->
      ...
      <tr>
        ...
        <td>
          <!-- {{ Form::date('dateofissue', '', array('id' => 'datepicker', 'class' => 'form-control', 'style' => 'width: 40%')) }} -->
        </td>
      </tr>
    </tbody>
  </table>
