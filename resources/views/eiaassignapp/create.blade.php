		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<div class="breadcrumb flat">
				    ...
				    <a href="#">MANAGE</a>
				    <a href="#">Assignment</a>
				    <a class="active">Applicant Assignment</a>        
				  </div>
				</div>
				...
				<input type="search" class="light-table-filter" data-table="order-table"  placeholder="Search..." style="width: 17%; float:right; margin-right: 200px"><br><br>
				...
				<table class="order-table table" id="list" style="width:80%;" align="center">
				    <thead valign="top">
				      <tr>
				        ...
				        <th onclick="sortTable(9)" style="width:8%;"><center>Action</center></th>
				      </thead>
				      ...
				      <tr>
					    ...
					    <input type="submit" class="button" value="Send to SME" />
						</form></center></td>
				        </tbody>
				...
				<div class="col-md-12 col-md-offset-0">
				  ...
				  <input type="submit" class="btn btn-success"></div><br><br>       
				 </div>
				 </div>         
