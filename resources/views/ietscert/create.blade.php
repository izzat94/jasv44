		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<div class="breadcrumb flat">
				...
				<thead valign="top">
				      <tr>
				        <th onclick="sortTable(0)" style="width: 5%;"><center>No.</center></th>
				        ...
				        <th onclick="sortTable(8)" style="width: 10%;"><center>Action</center></th>
				    ...
				    <tbody>
				      <tr>
				        ...
				        <td><center><form action="{{ url('ietsendorse/create') }}" method="get">
				        ...
				        <td><form><textarea rows="4" cols="15"></textarea>
							...
							<td><form onclick="deleteRow(this)" align="center">
							  <center>{{ HTML::image('images/delete.ico', 'a Delete', array('class' => 'img-responsive cleaner', 'width' => '15', 'height' => '15' )) }}</center>
							</form><br>

							<center>{{ HTML::image('images/edit.png', 'a Delete', array('class' => 'img-responsive cleaner', 'width' => '15', 'height' => '15' )) }}</center></td>
							<td><select>
							<option value="">--Please Select--</option>
				...
				<thead>
				      <tr>
				        ...
				        <th onclick="sortTable1(1)" style="width: 12%;"><center>Applicant Name</center></th>
				        <th onclick="sortTable1(2)" style="width: 12%;"><center>NRIC/Passport</center></th>
				        <th onclick="sortTable1(3)" style="width: 13%;"><center>Title</center></th>
