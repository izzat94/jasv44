		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<div class="breadcrumb flat">
				    ...
				    <a href="#">MANAGE</a>
				    <a href="#">Assignment</a>
				    <a class="active">Course Assignment</a>        
				  </div>
				</div>
				...
				<br>            
				 ...
				 {!! Form::open(array('route' => 'eiaassignment.store', 'data-parsley-validate' => '')) !!}
						    ...
						    <input type="text" id="sa" name="specialized" class="form-control" required="" style="width:36.6%">
						    </div><br>
					      ...
					      {{Form::submit('Save', array('class' => 'btn btn-success'))}}<hr><br>
					    </div>
					  {!! Form::close() !!} 
