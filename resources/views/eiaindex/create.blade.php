				    ...
				    $('[data-toggle="popover"]').popover();   
                  		...
                  		<div class="col-md-2 col-sm-2 col-md-offset-0 box0">
                  			<div class="box1">
					  			...
					  			<a style="color:orange;" href="{{ url('eiaassignapp/create') }}"><h3>Assignment<br><br>{{ $eiaassignapp }}</h3></a>
                  			</div>
                  		...
                  		<div class="col-md-2 col-sm-2 col-md-offset-0 box0">
                  			<div class="box1">
					  			...
					  			<a style="color:green;" href="{{ url('eiaproiv/create') }}"><h3>Interview<br><br>{{ $eiaproiv }}</h3></a>
                  			</div>
                  		...
                  		<div class="col-md-2 col-sm-2 col-md-offset-0 box0">
                  			<div class="box1">
					  			...
					  			<a style="color:blue;" href="{{ url('eiacert/create') }}"><h3>Certificate<br><br>{{ $eiacert }}</h3></a>
                  			</div>
