    ...
    <div class="panel panel-primary"style="width:90%;margin-left:30px">
      ...
      <div id="collapse1" class="panel-collapse collapse">
        <div class="panel-body">1. Applicants who fulfilled the passing criteria in both comprehensive exam and assignments, will be called for the viva or final interview for the final assessment.<br>
					...
					<h5 style="margin-left:15%;">Below are the confirmation details of the Professional Interview:</h5>
					 <table>
					<tr></tr>
					<table id="iv_table" class="table" style="margin-left:15%;width:70%">
					<?php
						foreach ($iets_confirmediv as $interview) {
					?>
					@if(Auth::user()->name ==$interview->user_name)
						<tr>
					<th style="width:0.5%">Name:</th>
					<td style="width:1%">{{ $interview->user_name }}</td>
					</tr>
					<tr>
					<th style="width:0.5%">Date:</th>
					<td style="width:1%">{{ $interview->date_iv }}</td>
					</tr>
					
					<tr>
					<th style="width:0.5%">Time:</th>
					<td style="width:1%"><?php echo $interview->time_iv?></td>
					</tr>
					<tr>
					<th style="width:0.5%">Venue:</th>
					<td style="width:1%"><?php echo $interview->venue_iv?></td>
					</tr>
						@endif
					<?php
						}
...
<label style="color:red;margin-left:15%">**Please make sure that..... </label>
