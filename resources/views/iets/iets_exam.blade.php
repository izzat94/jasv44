...
<div class="container">
	...
	<h5 style="margin-left:15%;">Below are the details of the Comprehensive Examination:</h5>
					...
					<td id="seat2"style="width:1%"><?php echo $exam_schedule->seat?></td>
					</tr>
					<tr id="seat">
					<th style="width:0.2%">Booked no:</th>
					<td id="seat2"style="width:1%">{{ $examuser}}</td>
					</tr>
...
@if(count($ietsuserexam) > 0)
	
	<center> 
 <a id="show-button"  href="{{action('IETS_ExamScheduleController@confirm')}}" class="btn btn-primary">Confirm</a> <br>
